...
import Persistence.CredentialsPostGres;
...
public class CreateAllDBTables {
    public static String createTableStockPrices() {
        ...
        String sqlstockprices = "CREATE TABLE IF NOT EXISTS stockprices_daily (date DATE, ticker VARCHAR(6)," +
                ...
                "daysinbol INT," +
                "ma10abvma21ema Varchar(3),"+
                "ema21abv50ma Varchar(3), "+
                "PRIMARY KEY (date, ticker)," +
              "FOREIGN KEY (ticker) REFERENCES tickersdetails(ticker));";
        String sqltickersdetails = "CREATE TABLE IF NOT EXISTS tickerdetails(ticker VARCHAR(6),list_date DATE,delisted_utc DATE,market_cap Numeric(20,2),shares_outstanding NUMERIC(20, 0)"
